...
set label 3  '\ft $0.3$\,cm' at 0.11,308 left front tc ls 10
set label 4  '\ft $0.5$\,cm' at 0.11,268 left front tc ls 9
set label 5  '\ft $1$\,cm'   at 0.11,228 left front tc ls 8
set label 6  '\ft $2$\,cm'   at 0.11,188.5 left front tc ls 7
set label 7  '\ft $4$\,cm'   at 0.11,148.5 left front tc ls 6
set label 8  '\ft $8$\,cm'   at 0.11,110  left front tc ls 5
set label 9  '\ft $17$\,cm'  at 0.11,71  left front tc ls 4
set label 10 '\ft $34$\,cm'  at 0.11,32   left front tc ls 3
set label 11 '\ft $67$\,cm'  at 0.11,-10 left front tc ls 2
set label 12 '\ft stereo'    at 0.11,-51.5 left front tc ls 23
...
set label 3  at 0.11,306
set label 4  at 0.11,265.5
set label 5  at 0.11,225
set label 6  at 0.11,185.5
set label 7  at 0.11,146
set label 8  at 0.11,108
set label 9  at 0.11,70
