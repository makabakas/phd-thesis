...
set label 6 '\ft moving focused/line source' at  0.7,  7.5 left   front tc ls 7
set label 7 '\ft (2.66)'                     at  4.0,  3.0 center front tc ls 7
set label 8 '\ft (2.77)'                     at -3.0,  4.5 center front tc ls 7
set tmargin 1.2
set bmargin 1
load 'greens.pal'
plot 'amplitudes_moving_source_2D_X0.0_Y-2.0.txt' u 1:($3-$2) w l ls 6 lw 3,\
     'amplitudes_moving_source_2D_X0.0_Y-4.0.txt' u 1:($3-$2) w l ls 7 lw 3,\
     'amplitudes_moving_source_2D_X2.0_Y-2.0.txt' u 1:($3-$2) w l ls 8 lw 3,\
     '<echo "0 0"' w p pt 7 ps 1.5 lc rgb 'black'
set label  1 '2.5D'
unset label 2
set label  7 '\ft (2.62)'                    at  4.0, -4.9
set label  8 '\ft (2.74)'                    at -3.5,  2.4
set label  9 '\ft (2.60)'                    at  4.0,  4.0 center front tc ls 3
set label 10 '\ft (2.72)'                    at -2.7,-12.0 center front tc ls 3 
set border 3
...
set tmargin 0
load 'blues.pal'
plot 'amplitudes_moving_source_25D_ps_X0.0_Y-2.0.txt' u 1:($3-$2) w l ls 2 lw 3,\
     'amplitudes_moving_source_25D_ps_X0.0_Y-4.0.txt' u 1:($3-$2) w l ls 3 lw 3,\
     'amplitudes_moving_source_25D_ps_X2.0_Y-2.0.txt' u 1:($3-$2) w l ls 4 lw 3,\
     'amplitudes_moving_source_25D_X0.0_Y-2.0.txt'    u 1:($3-$2) w l ls 6 lw 3,\
     'amplitudes_moving_source_25D_X0.0_Y-4.0.txt'    u 1:($3-$2) w l ls 7 lw 3,\
     'amplitudes_moving_source_25D_X2.0_Y-2.0.txt'    u 1:($3-$2) w l ls 8 lw 3,\
     '<echo "0 0"' w p pt 7 ps 1.5 lc rgb 'black'
unset multiplot
