...
gp_save_matrix('data/sound_field_fs_1000Hz.dat',x,y,real(P));
...
P = normalization(P,'point');
gp_save_matrix('data/sound_field_fs_2000Hz.dat',x,y,real(P));
f = 5000; % / Hz
[P,x,y] = sound_field_mono_wfs(X,Y,Z,xs,src,f,conf);
P = normalization(P,'point');
gp_save_matrix('data/sound_field_fs_5000Hz.dat',x,y,real(P));
