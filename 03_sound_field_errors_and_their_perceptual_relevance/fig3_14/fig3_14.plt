...
plot [*:*] [-5:1] 'nfchoa_X0.00_Y0.00_nls64.txt' u ($1*1000):($2/STATS_max)   w l ls 1 lw 2,\
                  'nfchoa_X0.75_Y0.00_nls64.txt' u ($1*1000):($2/STATS_max-2) w l ls 2 lw 2,\
                  'nfchoa_X0.00_Y0.75_nls64.txt' u ($1*1000):($2/STATS_max-4) w l ls 3 lw 2
set origin 0.67,0.5
unset label 3
unset label 4
load 'xborder.cfg'
...
plot [*:*] [-5:1] 'nfchoa_X0.00_Y0.00_nls64_band_limited.txt' u ($1*1000):($2/STATS_max)   w l ls 1 lw 2,\
                  'nfchoa_X0.75_Y0.00_nls64_band_limited.txt' u ($1*1000):($2/STATS_max-2) w l ls 2 lw 2,\
                  'nfchoa_X0.00_Y0.75_nls64_band_limited.txt' u ($1*1000):($2/STATS_max-4) w l ls 3 lw 2
set origin 0,0
load 'xyborder.cfg'
set ylabel 'sound pressure'
set bmargin 3.2
...
plot [*:*] [-5:1] 'wfs_X0.00_Y0.00.txt' u ($1*1000):($2/STATS_max)   w l ls 1 lw 2,\
                  'wfs_X0.75_Y0.00.txt' u ($1*1000):($2/STATS_max-2) w l ls 2 lw 2,\
                  'wfs_X0.00_Y0.75.txt' u ($1*1000):($2/STATS_max-4) w l ls 3 lw 2
set origin 0.335,0
...
plot [*:*] [-5:1] 'wfs_X0.00_Y0.00_nls64.txt' u ($1*1000):($2/STATS_max)   w l ls 1 lw 2,\
                  'wfs_X0.75_Y0.00_nls64.txt' u ($1*1000):($2/STATS_max-2) w l ls 2 lw 2,\
                  'wfs_X0.00_Y0.75_nls64.txt' u ($1*1000):($2/STATS_max-4) w l ls 3 lw 2
unset multiplot
